...
Y_hat = np.dot(X_1a, w)
plt.suptitle("1A")
res = residual(Y, Y_hat)
plt.title("Res sum squares error: " + str(res))
plt.savefig('plot-4-1a.png')
plt.show()
